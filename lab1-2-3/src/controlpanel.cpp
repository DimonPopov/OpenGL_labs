...
void ControlPanel::initControlElement()
{
    ...
    connect(spinRef, QOverload<double>::of(&QDoubleSpinBox::valueChanged),
            this, &ControlPanel::handleTransparencySpinBoxChanged);
    ...
    blendBox1->setToolTip(tr("S factor"));
    ...
    blendBox2->setToolTip(tr("D factor"));
    ...
    xSlider->setRange(0, currentFigure->width());
    ySlider->setRange(0, currentFigure->height());
    wSlider->setRange(0, currentFigure->width());
    hSlider->setRange(0, currentFigure->height());
